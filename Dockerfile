...
WORKDIR /opt
ADD http://www.apache.org/dist/hbase/hbase-0.94.20/hbase-0.94.20.tar.gz /opt/downloads/
...
RUN rm -Rf /opt/opentsdb && git clone git://github.com/OpenTSDB/opentsdb.git --branch next /opt/opentsdb
